...
class TwoImages650x682and290x300LeftTextRightBlock(BaseBlock):
    ...
    class Meta:
        icon = 'user'
        template = 'home/blocks/two_images_650x682_and_290x300_left_text_right_block.html'
        # max_num = 1
...
class BlurbUnitBlock(blocks.StructBlock):
    title = blocks.CharBlock()
    text = blocks.CharBlock()
    icon_120x120 = ImageChooserBlock(required=False)
